            ...
            {arquivosDaAula.length > 0 ? (
              <div className="space-y-4">
                {arquivosDaAula.map((arquivo) => (
                  <div
                    key={arquivo.id}
                    className="flex min-w-0 flex-col gap-4 rounded-[22px] border border-slate-100 bg-white p-4 shadow-lg shadow-slate-200/60 md:flex-row md:items-center md:justify-between"
                  >
                    <div className="flex min-w-0 items-start gap-3">
                      <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[#EEF2FF] text-2xl">
                        📄
                      </div>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex shrink-0 items-center justify-center rounded-2xl bg-gradient-to-b from-[#F3F4F6] via-[#D1D5DB] to-[#9CA3AF] px-5 py-3 text-center text-sm font-black text-[#08163F] shadow-lg transition hover:scale-[1.01] hover:brightness-105"
                    >
                      Abrir material →
                    </a>
                  </div>
